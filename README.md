## Welcome to the user verifiction swagger specification
...
#### API Docs
Our API specification is available at the following link. [Click here for the API documentation](https://sentenial.github.io/verification-swagger/docs/redoc.html). 
